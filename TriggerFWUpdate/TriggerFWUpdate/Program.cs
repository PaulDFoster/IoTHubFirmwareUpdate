...
namespace TriggerFWUpdate
{
    class Program
    {
        ...
        static string connString = "HostName=<iothubname>.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=<iothubowneraccesskey>";
        static ServiceClient client;
        static string targetDevice = "surfacepro4";
